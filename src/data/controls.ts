...
export const controlObjectives: ControlObjective[] = [
  {
    ...
    conceptIds: ['accountability', 'decision-rights', 'human-oversight', 'senior-accountability'], riskIds: ['mit-risk-5-2', 'mit-risk-6-5', 'mit-risk-7-1'],
  ...
  },
  {
    ...
    conceptIds: ['inventory', 'materiality', 'third-party-risk', 'use-case-intake'], riskIds: ['mit-risk-6-5', 'mit-risk-6-1', 'mit-risk-7-3'],
  ...
  },
  {
    ...
    conceptIds: ['decision-rights', 'materiality', 'risk-treatment', 'human-oversight', 'use-case-intake', 'ai-policy-appetite'], riskIds: ['mit-risk-5-2', 'mit-risk-6-4', 'mit-risk-6-5', 'mit-risk-7-2'],
  ...
  },
  {
    ...
    conceptIds: ['materiality', 'human-rights', 'systemic-risk', 'ai-policy-appetite'], riskIds: ['mit-risk-5-1', 'mit-risk-6-1', 'mit-risk-6-2', 'mit-risk-7-5'],
  ...
  },
  {
    ...
    conceptIds: ['impact-assessment', 'risk-treatment', 'human-rights', 'fairness-bias', 'environmental-impact', 'workforce-impact'], riskIds: ['mit-risk-1-1', 'mit-risk-1-3', 'mit-risk-6-1', 'mit-risk-6-6', 'mit-risk-6-2'],
  ...
  },
  {
    ...
    conceptIds: ['provenance', 'data-governance', 'traceability', 'intellectual-property'], riskIds: ['mit-risk-2-1', 'mit-risk-3-1', 'mit-risk-3-2', 'mit-risk-4-3'],
  ...
  },
  {
    ...
    conceptIds: ['access-control', 'agent-authority', 'ai-security'], riskIds: ['mit-risk-2-1', 'mit-risk-2-2', 'mit-risk-4-2', 'mit-risk-7-2', 'mit-risk-7-6'],
  ...
  },
  {
    ...
    conceptIds: ['ai-security', 'supply-chain', 'change-management', 'provenance', 'secure-development'], riskIds: ['mit-risk-2-2', 'mit-risk-4-2', 'mit-risk-7-2', 'mit-risk-7-3'],
  ...
  },
  {
    ...
    conceptIds: ['agent-authority', 'runtime-guardrails', 'human-oversight'], riskIds: ['mit-risk-4-2', 'mit-risk-5-2', 'mit-risk-7-1', 'mit-risk-7-2', 'mit-risk-7-6'],
  ...
  },
  {
    ...
    conceptIds: ['transparency-disclosure', 'provenance', 'human-rights', 'content-authenticity'], riskIds: ['mit-risk-3-1', 'mit-risk-3-2', 'mit-risk-4-3', 'mit-risk-5-1'],
  ...
  },
  {
    ...
    conceptIds: ['explainability', 'transparency-disclosure', 'documentation', 'consumer-outcomes'], riskIds: ['mit-risk-3-1', 'mit-risk-5-1', 'mit-risk-7-4'],
  ...
  },
  {
    ...
    conceptIds: ['contestability', 'human-rights', 'human-oversight', 'consumer-outcomes'], riskIds: ['mit-risk-1-1', 'mit-risk-1-3', 'mit-risk-5-1', 'mit-risk-5-2'],
  ...
  },
  {
    ...
    conceptIds: ['evaluation', 'reliability', 'materiality', 'model-risk'], riskIds: ['mit-risk-1-3', 'mit-risk-3-1', 'mit-risk-7-3', 'mit-risk-7-4'],
  ...
  },
  {
    ...
    conceptIds: ['fairness-bias', 'human-rights', 'evaluation', 'impact-assessment', 'consumer-outcomes'], riskIds: ['mit-risk-1-1', 'mit-risk-1-2', 'mit-risk-1-3', 'mit-risk-6-2'],
  ...
  },
  {
    ...
    conceptIds: ['red-teaming', 'ai-security', 'supply-chain', 'content-safety'], riskIds: ['mit-risk-2-2', 'mit-risk-4-2', 'mit-risk-4-3', 'mit-risk-7-1', 'mit-risk-7-2', 'mit-risk-7-6', 'mit-risk-1-2'],
  ...
  },
  {
    ...
    conceptIds: ['continuous-monitoring', 'reliability', 'incident-response', 'runtime-guardrails', 'model-risk', 'content-safety'], riskIds: ['mit-risk-1-2', 'mit-risk-3-2', 'mit-risk-6-6', 'mit-risk-7-1', 'mit-risk-7-3', 'mit-risk-7-6'],
  ...
  },
  {
    ...
    conceptIds: ['human-oversight', 'agent-authority'], riskIds: ['mit-risk-5-1', 'mit-risk-5-2', 'mit-risk-7-1', 'mit-risk-7-2', 'mit-risk-7-6'],
  ...
  },
  {
    ...
    conceptIds: ['operational-resilience', 'human-oversight', 'exitability', 'third-party-risk'], riskIds: ['mit-risk-2-2', 'mit-risk-7-1', 'mit-risk-7-3', 'mit-risk-7-6'],
  ...
  },
  {
    ...
    conceptIds: ['change-management', 'lifecycle-governance', 'exitability', 'documentation', 'model-risk'], riskIds: ['mit-risk-6-4', 'mit-risk-6-5', 'mit-risk-7-1', 'mit-risk-7-3'],
