...
const ceilings = { important: 84, hex: 679, bytes: 151662 }
...
describe('legacy stylesheet ratchet', () => {
  it('does not add !important, raw hex colours or bytes to legacy CSS', () => {
    ...
    expect(Buffer.byteLength(legacy)).toBeLessThanOrEqual(ceilings.bytes)
  })
