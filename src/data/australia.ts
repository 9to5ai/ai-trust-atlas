...
export const australianInstruments = [
  ...
  makeInstrument({
    ...
    provisions: [{ id: 'corp-act-afs', ref: 'Chapter 7', title: 'Financial services and markets', summary: 'Establishes licensing, conduct, disclosure and product duties relevant when AI supports financial services.', conceptIds: ['accountability', 'competence', 'transparency-disclosure', 'contestability'] }],
  }),
  makeInstrument({
    id: 'au-asic-act', title: 'Australian Securities and Investments Commission Act 2001', shortTitle: 'ASIC Act', issuer: 'Australian Parliament', jurisdiction: 'Australia', region: 'Australia', authorityClass: 'law', authorityNote: "Legally binding within its scope", status: 'in-force', published: '2001', officialUrl: 'https://www.legislation.gov.au/C2004A00819/latest/text',
    ...
    provisions: [{ id: 'asic-act-consumer', ref: 'Part 2 Division 2', title: 'Financial consumer protection', summary: 'Prohibits misleading, deceptive and unconscionable conduct in financial services.', conceptIds: ['transparency-disclosure', 'fairness-bias', 'contestability'] }],
  }),
  makeInstrument({
    id: 'au-far-act', title: 'Financial Accountability Regime Act 2023', shortTitle: 'FAR Act', issuer: 'Australian Parliament', jurisdiction: 'Australia', region: 'Australia', authorityClass: 'law', authorityNote: "Legally binding within its scope", status: 'in-force', published: '2023', effective: '2024-03-15 / 2025-03-15', officialUrl: 'https://www.legislation.gov.au/C2023A00067/latest/versions',
    ...
    provisions: [{ id: 'far-accountability', ref: 'Accountability obligations', title: 'Reasonable steps and clear responsibility', summary: 'Requires covered entities and accountable persons to take reasonable steps and maintain clear responsibility records.', conceptIds: ['accountability', 'decision-rights', 'auditability'] }],
  }),
  makeInstrument({
    id: 'apra-cps-220', title: 'CPS 220 Risk Management', shortTitle: 'APRA CPS 220', issuer: 'Australian Prudential Regulation Authority', jurisdiction: 'Australia - APRA-regulated entities', region: 'Australia', authorityClass: 'law', authorityNote: "Legally binding prudential standard within its scope", status: 'in-force', published: '2019', officialUrl: 'https://www.apra.gov.au/standards/cps-220',
    ...
    provisions: [{ id: 'cps220-framework', ref: 'Risk management framework', title: 'All material risks', summary: 'Requires a board-approved framework covering all material risks, appetite, controls, monitoring and independent review.', conceptIds: ['materiality', 'risk-treatment', 'continuous-monitoring', 'assurance'] }],
  }),
  makeInstrument({
    id: 'asic-rep-798', title: 'REP 798 Beware the gap: Governance arrangements in the face of AI innovation', shortTitle: 'ASIC REP 798', issuer: 'Australian Securities and Investments Commission', jurisdiction: 'Australia - AFS and credit licensees', region: 'Australia', authorityClass: 'research-database', authorityNote: "Informational research", status: 'active', published: '2024-10-29', officialUrl: 'https://www.asic.gov.au/regulatory-resources/find-a-document/reports/rep-798-beware-the-gap-governance-arrangements-in-the-face-of-ai-innovation',
    ...
    provisions: [{ id: 'rep798-findings', ref: 'Key findings', title: 'Governance is lagging adoption', summary: 'Identifies incomplete inventories, uneven risk frameworks and gaps in third-party and consumer-risk governance.', conceptIds: ['inventory', 'accountability', 'third-party-risk', 'fairness-bias'] }],
  }),
  makeInstrument({
    id: 'au-ai-adoption-guidance', title: 'Guidance for AI Adoption: Implementation Guidance', shortTitle: 'AI Adoption Guidance', issuer: 'Australian Government National AI Centre', jurisdiction: 'Australia', region: 'Australia', authorityClass: 'policy-guidance', authorityNote: "Guidance; see scope below", status: 'voluntary', published: '2026-05-05', officialUrl: 'https://www.ai.gov.au/staying-safe-and-responsible/essential-ai-practices/guidance-ai-adoption-implementation-guidance',
  ...
  makeInstrument({
    id: 'dta-ai-policy', title: 'Policy for the Responsible Use of AI in Government 2.0', shortTitle: 'Government AI Policy', issuer: 'Digital Transformation Agency', jurisdiction: 'Australian Government', region: 'Australia', authorityClass: 'policy-guidance', authorityNote: "Mandatory policy for covered Commonwealth entities; exceptions apply", status: 'active', published: '2025-12-01', effective: '2025-12-15', officialUrl: 'https://www.digital.gov.au/ai/ai-in-government-policy',
    ...
    provisions: [{ id: 'dta-ai-policy-requirements', ref: 'Policy requirements', title: 'Accountability and transparency', summary: 'Requires accountable officials, AI strategies, transparency statements, use-case ownership and staff capability.', conceptIds: ['accountability', 'inventory', 'transparency-disclosure', 'competence'] }],
  }),
  makeInstrument({
  ...
  makeInstrument({
    ...
    provisions: [{ id: 'asd-ai-supply-controls', ref: 'Risk mitigations', title: 'Trace and govern the AI supply chain', summary: 'Recommends component inventories, provenance, due diligence, shared responsibility, monitoring and response planning.', conceptIds: ['supply-chain', 'provenance', 'third-party-risk', 'incident-response'] }],
  }),
  makeInstrument({
  ...
  makeInstrument({
    id: 'asic-ai-cyber-letter', title: 'ASIC Open Letter: Urgent Cyber Uplift as AI Accelerates Cyber Threats', shortTitle: 'ASIC AI Cyber Letter', issuer: 'Australian Securities and Investments Commission', jurisdiction: 'Australia - licensees and market participants', region: 'Australia', authorityClass: 'policy-guidance', authorityNote: "Supervisory expectations; see scope below", status: 'active', published: '2026-05-08', officialUrl: 'https://www.asic.gov.au/about-asic/news-centre/find-a-media-release/2026-releases/26-092mr-asic-calls-for-urgent-cyber-uplift-as-ai-accelerates-cyber-threats',
    ...
    provisions: [{ id: 'asic-cyber-actions', ref: 'Govern, protect, detect, respond', title: 'Cyber-resilience uplift', summary: 'Emphasises effective and proportionate controls, patching, privilege, suppliers and exercised response.', conceptIds: ['ai-security', 'access-control', 'third-party-risk', 'incident-response'] }],
  }),
]
